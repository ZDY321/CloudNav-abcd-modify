const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/jszip.min-CKBOkIhy.js","assets/index--ujpxUqt.js","assets/index-DvHZkPwq.css"])))=>i.map(i=>d[i]);
import{c as m,r as l,j as e,M as pe,X as ge,G as W,t as J,N as Z,F as E,O as me,Z as xe,Q as he,A as fe,_ as Y}from"./index--ujpxUqt.js";import{S as be}from"./sparkles-O0uXUYDC.js";/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ve=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"10",x2:"10",y1:"15",y2:"9",key:"c1nkhi"}],["line",{x1:"14",x2:"14",y1:"15",y2:"9",key:"h65svq"}]],ke=m("circle-pause",ve);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ye=[["path",{d:"m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4",key:"g0fldk"}],["path",{d:"m21 2-9.6 9.6",key:"1j0ho8"}],["circle",{cx:"7.5",cy:"15.5",r:"5.5",key:"yqb3hr"}]],we=m("key",ye);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ce=[["path",{d:"M10 8h.01",key:"1r9ogq"}],["path",{d:"M12 12h.01",key:"1mp3jc"}],["path",{d:"M14 8h.01",key:"1primd"}],["path",{d:"M16 12h.01",key:"1l6xoz"}],["path",{d:"M18 8h.01",key:"emo2bl"}],["path",{d:"M6 8h.01",key:"x9i8wu"}],["path",{d:"M7 16h10",key:"wp8him"}],["path",{d:"M8 12h.01",key:"czm47f"}],["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}]],Ie=m("keyboard",Ce);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=[["rect",{width:"18",height:"7",x:"3",y:"3",rx:"1",key:"f1a2em"}],["rect",{width:"9",height:"7",x:"3",y:"14",rx:"1",key:"jqznyg"}],["rect",{width:"5",height:"7",x:"16",y:"14",rx:"1",key:"q5h2i8"}]],Se=m("layout-template",Ue);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const je=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]],Le=m("refresh-cw",je);/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Me=[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.106-3.105c.32-.322.863-.22.983.218a6 6 0 0 1-8.259 7.057l-7.91 7.91a1 1 0 0 1-2.999-3l7.91-7.91a6 6 0 0 1 7.057-8.259c.438.12.54.662.219.984z",key:"1ngwbx"}]],Ne=m("wrench",Me),Ee=()=>{const d=Math.floor(Math.random()*360),g=70+Math.random()*20,p=45+Math.random()*15;return`hsl(${d}, ${g}%, ${p}%)`},Ae=(d,g,p)=>{let r="";d&&d.length>0?(r=d.charAt(0),/^[a-zA-Z]$/.test(r)&&(r="云")):r="云";const b="g_"+Math.random().toString(36).substr(2,9),v=`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
        ...
        <rect width="100%" height="100%" fill="url(#${b})" rx="16"/>
        <text x="50%" y="50%" dy=".35em" fill="white" font-family="Arial, sans-serif" font-weight="bold" font-size="32" text-anchor="middle">${r}</text>
    </svg>`.trim();try{return`data:image/svg+xml;base64,${window.btoa(unescape(encodeURIComponent(v)))}`}catch(S){return console.error("SVG Icon Generation Failed",S),""}},_e=({isOpen:d,onClose:g,config:p,siteSettings:r,onSave:b,links:v,categories:S,onUpdateLinks:Q,authToken:A})=>{const[k,X]=l.useState("site"),[u,T]=l.useState(p),[c,R]=l.useState(()=>({title:(r==null?void 0:r.title)||"CloudNav - 我的导航",navTitle:(r==null?void 0:r.navTitle)||"CloudNav",favicon:(r==null?void 0:r.favicon)||"/favicon.png",cardStyle:(r==null?void 0:r.cardStyle)||"detailed",passwordExpiryDays:(r==null?void 0:r.passwordExpiryDays)??7})),[_,ee]=l.useState([]),[te,y]=l.useState(!1),[w,j]=l.useState({current:0,total:0}),C=l.useRef(!1),[L,ae]=l.useState(""),[B,re]=l.useState(""),[x,z]=l.useState("chrome"),[$,M]=l.useState(!1),[N,D]=l.useState({}),P=t=>{const a=[];for(let n=0;n<6;n++){const i=Ee(),o=`hsl(${(parseInt(i.split(",")[0].split("(")[1])+30+Math.random()*30)%360}, 70%, 50%)`;a.push(Ae(t,i,o))}ee(a)};l.useEffect(()=>{if(d){T(p);const t={title:(r==null?void 0:r.title)||"CloudNav - 我的导航",navTitle:(r==null?void 0:r.navTitle)||"CloudNav",favicon:(r==null?void 0:r.favicon)||"/favicon.png",cardStyle:(r==null?void 0:r.cardStyle)||"detailed"};R(t),_.length===0&&P(t.navTitle),y(!1),M(!1),j({current:0,total:0}),C.current=!1,re(window.location.origin);const a=localStorage.getItem("cloudnav_auth_token");a&&ae(a)}},[d,p,r]);const I=(t,a)=>{T(n=>({...n,[t]:a}))},h=async(t,a)=>{R(n=>{const i={...n,[t]:a};return t==="passwordExpiryDays"&&A&&ne(i),i})},ne=async t=>{try{const a=await fetch("/api/storage",{method:"POST",headers:{"Content-Type":"application/json","x-auth-password":A||""},body:JSON.stringify({saveConfig:"website",config:t})});a.ok||console.error("Failed to save website config to KV:",a.statusText)}catch(a){console.error("Error saving website config to KV:",a)}},ie=()=>{b(u,c),g()},se=async()=>{if(!u.apiKey){alert("请先配置并保存 API Key");return}const t=v.filter(i=>!i.description);if(t.length===0){alert("所有链接都已有描述！");return}if(!confirm(`发现 ${t.length} 个链接缺少描述，确定要使用 AI 自动生成吗？这可能需要一些时间。`))return;y(!0),C.current=!1,j({current:0,total:t.length});let a=[...v];const{generateLinkDescription:n}=await Y(async()=>{const{generateLinkDescription:i}=await import("./geminiService-CpgMh6MS.js");return{generateLinkDescription:i}},[]);for(let i=0;i<t.length&&!C.current;i++){const s=t[i];try{const o=await n(s.title,s.url,u);a=a.map(f=>f.id===s.id?{...f,description:o}:f),Q(a),j({current:i+1,total:t.length})}catch(o){console.error(`Failed to generate for ${s.title}`,o)}}y(!1)},H=(t,a)=>{navigator.clipboard.writeText(t),D(n=>({...n,[a]:!0})),setTimeout(()=>{D(n=>({...n,[a]:!1}))},2e3)},oe=(t,a)=>{const n=new Blob([a],{type:"text/plain;charset=utf-8"}),i=URL.createObjectURL(n),s=document.createElement("a");s.href=i,s.download=t,document.body.appendChild(s),s.click(),document.body.removeChild(s),URL.revokeObjectURL(i)},F=()=>{const t={manifest_version:3,name:(c.navTitle||"CloudNav")+" Pro",version:"7.6",minimum_chrome_version:"116",description:"CloudNav - 极速侧边栏与智能收藏",permissions:["activeTab","scripting","sidePanel","storage","favicon","contextMenus","notifications","tabs"],background:{service_worker:"background.js"},action:{default_title:"打开侧边栏 (Ctrl+Shift+E)"},side_panel:{default_path:"sidebar.html"},icons:{128:"icon.png"},commands:{_execute_action:{suggested_key:{default:"Ctrl+Shift+E",mac:"Command+Shift+E"},description:"打开 CloudNav 侧边栏"}}};return x==="firefox"&&(t.browser_specific_settings={gecko:{id:"cloudnav@example.com",strict_min_version:"109.0"}}),JSON.stringify(t,null,2)},O=JSON.stringify({apiBase:B,appUrl:typeof window<"u"?`${window.location.origin}${window.location.pathname}`:"",password:L}),K=`// background.js - CloudNav Assistant v7.6
const CONFIG = ${O};
...
});`,U=(t,a)=>e.jsxs("div",{className:"rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden shrink-0",children:[e.jsxs("div",{className:"flex justify-between items-center bg-slate-50 dark:bg-slate-700/50 px-3 py-2 border-b border-slate-200 dark:border-slate-700",children:[e.jsx("span",{className:"text-xs font-mono font-medium text-slate-600 dark:text-slate-300",children:t}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsxs("button",{onClick:()=>oe(t,a),className:"text-xs flex items-center gap-1 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 hover:underline",title:"下载文件",children:[e.jsx(E,{size:12}),"Download"]}),e.jsx("div",{className:"w-px h-3 bg-slate-300 dark:bg-slate-600"}),e.jsxs("button",{onClick:()=>H(a,t),className:"text-xs flex items-center gap-1 text-blue-600 dark:text-blue-400 hover:underline",children:[N[t]?e.jsx(J,{size:12}):e.jsx(Z,{size:12}),N[t]?"Copied":"Copy"]})]})]}),e.jsx("div",{className:"bg-slate-900 p-3 overflow-x-auto",children:e.jsx("pre",{className:"text-[10px] md:text-xs font-mono text-slate-300 leading-relaxed whitespace-pre",children:a})})]}),V=async()=>{const t=c.favicon;if(!t)return null;try{const a=new Image;a.crossOrigin="anonymous",a.src=t,await new Promise((s,o)=>{a.onload=s,a.onerror=o});const n=document.createElement("canvas");n.width=128,n.height=128;const i=n.getContext("2d");if(!i)throw new Error("Canvas error");return i.drawImage(a,0,0,128,128),new Promise(s=>{n.toBlob(o=>{s(o)},"image/png")})}catch(a){return console.error(a),null}},le=async()=>{const t=await V();if(!t){alert(`生成图片失败 (可能是跨域限制)。

请尝试右键点击下方的预览图片，选择 '图片另存为...' 保存。`);return}const a=window.URL.createObjectURL(t),n=document.createElement("a");n.href=a,n.download="icon.png",document.body.appendChild(n),n.click(),document.body.removeChild(n),window.URL.revokeObjectURL(a)},ce=async()=>{M(!0);try{const{default:t}=await Y(async()=>{const{default:f}=await import("./jszip.min-CKBOkIhy.js").then(ue=>ue.j);return{default:f}},__vite__mapDeps([0,1,2])),a=new t;a.file("manifest.json",F()),a.file("background.js",K),a.file("sidebar.html",G),a.file("sidebar.js",q);const n=await V();n?a.file("icon.png",n):(console.warn("Could not generate icon for zip"),a.file("icon_missing.txt","Icon generation failed due to CORS. Please save the icon manually."));const i=await a.generateAsync({type:"blob"}),s=window.URL.createObjectURL(i),o=document.createElement("a");o.href=s,o.download="CloudNav-Ext.zip",document.body.appendChild(o),o.click(),document.body.removeChild(o),window.URL.revokeObjectURL(s)}catch(t){console.error(t),alert("打包下载失败")}finally{M(!1)}};if(!d)return null;const de=[{id:"site",label:"网站设置",icon:Se},{id:"ai",label:"AI 设置",icon:pe},{id:"tools",label:"扩展工具",icon:Ne}];return e.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm",children:e.jsxs("div",{className:"bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden border border-slate-200 dark:border-slate-700 flex max-h-[90vh] flex-col md:flex-row",children:[e.jsx("div",{className:"w-full md:w-48 bg-slate-50 dark:bg-slate-800/50 border-r border-slate-200 dark:border-slate-700 flex flex-row md:flex-col p-2 gap-1 overflow-x-auto shrink-0",children:de.map(t=>e.jsxs("button",{onClick:()=>X(t.id),className:`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${k===t.id?"bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300":"text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700"}`,children:[e.jsx(t.icon,{size:18}),t.label]},t.id))}),e.jsxs("div",{className:"flex-1 flex flex-col min-w-0 min-h-0 overflow-hidden bg-white dark:bg-slate-800",children:[e.jsxs("div",{className:"flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700 shrink-0",children:[e.jsx("h3",{className:"text-lg font-semibold dark:text-white",children:"设置"}),e.jsx("button",{onClick:g,className:"p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-full transition-colors",children:e.jsx(ge,{className:"w-5 h-5 dark:text-slate-400"})})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto p-6 pb-12",children:[k==="site"&&e.jsx("div",{className:"space-y-6 animate-in fade-in duration-300",children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"网页标题 (Title)"}),e.jsx("input",{type:"text",value:c.title,onChange:t=>h("title",t.target.value),className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"导航栏标题"}),e.jsx("input",{type:"text",value:c.navTitle,onChange:t=>h("navTitle",t.target.value),className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"网站图标 (Favicon URL)"}),e.jsxs("div",{className:"flex gap-3 items-center",children:[e.jsx("div",{className:"w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center overflow-hidden border border-slate-200 dark:border-slate-600",children:c.favicon?e.jsx("img",{src:c.favicon,className:"w-full h-full object-cover"}):e.jsx(W,{size:20,className:"text-slate-400"})}),e.jsx("input",{type:"text",value:c.favicon,onChange:t=>h("favicon",t.target.value),placeholder:"https://example.com/favicon.ico",className:"flex-1 p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})]}),e.jsxs("div",{className:"mt-3",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("p",{className:"text-xs text-slate-500",children:"选择生成的随机图标 (点击右侧按钮刷新):"}),e.jsxs("button",{type:"button",onClick:()=>P(c.navTitle),className:"text-xs flex items-center gap-1 text-blue-600 hover:bg-blue-50 dark:hover:bg-slate-700 px-2 py-1 rounded transition-colors",children:[e.jsx(Le,{size:12})," 随机生成"]})]}),e.jsx("div",{className:"flex gap-2",children:_.map((t,a)=>e.jsx("button",{onClick:()=>h("favicon",t),className:"w-8 h-8 rounded hover:ring-2 ring-blue-500 transition-all border border-slate-100 dark:border-slate-600",children:e.jsx("img",{src:t,className:"w-full h-full rounded"})},a))})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"身份验证过期天数"}),e.jsx("div",{className:"relative",children:e.jsx("input",{type:"number",min:"0",value:c.passwordExpiryDays,onChange:t=>h("passwordExpiryDays",parseInt(t.target.value)||0),className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})}),e.jsx("p",{className:"text-xs text-slate-500 mt-1",children:"设置为 0 表示永久不退出，默认 7 天后自动退出"})]})]})}),k==="ai"&&e.jsxs("div",{className:"space-y-6 animate-in fade-in duration-300",children:[e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"AI 提供商"}),e.jsxs("select",{value:u.provider,onChange:t=>I("provider",t.target.value),className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500",children:[e.jsx("option",{value:"gemini",children:"Google Gemini"}),e.jsx("option",{value:"openai",children:"OpenAI Compatible (ChatGPT, DeepSeek, Claude...)"})]})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"API Key"}),e.jsxs("div",{className:"relative",children:[e.jsx(we,{size:16,className:"absolute left-3 top-1/2 -translate-y-1/2 text-slate-400"}),e.jsx("input",{type:"password",value:u.apiKey,onChange:t=>I("apiKey",t.target.value),placeholder:"sk-...",className:"w-full pl-10 p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500 font-mono"})]}),e.jsx("p",{className:"text-xs text-slate-500 mt-1",children:"Key 仅存储在本地浏览器缓存中，不会发送到我们的服务器。"})]}),u.provider==="openai"&&e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"Base URL (API 地址)"}),e.jsx("input",{type:"text",value:u.baseUrl,onChange:t=>I("baseUrl",t.target.value),placeholder:"https://api.openai.com/v1",className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})]}),e.jsxs("div",{children:[e.jsx("label",{className:"block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1",children:"模型名称 (Model Name)"}),e.jsx("input",{type:"text",value:u.model,onChange:t=>I("model",t.target.value),placeholder:u.provider==="gemini"?"gemini-2.5-flash":"gpt-3.5-turbo",className:"w-full p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white outline-none focus:ring-2 focus:ring-blue-500"})]}),e.jsxs("div",{className:"pt-4 border-t border-slate-100 dark:border-slate-700",children:[e.jsx("h4",{className:"text-sm font-semibold mb-2 dark:text-slate-200",children:"批量操作"}),te?e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex justify-between text-xs text-slate-600 dark:text-slate-400",children:[e.jsxs("span",{children:["正在生成描述... (",w.current,"/",w.total,")"]}),e.jsxs("button",{onClick:()=>{C.current=!0,y(!1)},className:"text-red-500 flex items-center gap-1 hover:underline",children:[e.jsx(ke,{size:12})," 停止"]})]}),e.jsx("div",{className:"w-full h-2 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden",children:e.jsx("div",{className:"h-full bg-blue-500 transition-all duration-300",style:{width:`${w.current/w.total*100}%`}})})]}):e.jsxs("button",{onClick:se,className:"flex items-center gap-2 text-sm text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 px-3 py-2 rounded-lg transition-colors border border-purple-200 dark:border-purple-800",children:[e.jsx(be,{size:16})," 一键补全所有缺失的描述"]})]})]}),k==="tools"&&e.jsxs("div",{className:"space-y-8 animate-in fade-in duration-300",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsxs("h4",{className:"font-medium text-slate-800 dark:text-slate-200 flex items-center gap-2",children:[e.jsx("span",{className:"flex items-center justify-center w-6 h-                                -6 rounded-full bg-blue-100 text-blue-600 text-xs font-bold",children:"1"}),"输入访问密码"]}),e.jsx("div",{className:"bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700",children:e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("label",{className:"text-xs text-slate-500 mb-1 block",children:"API 域名 (自动获取)"}),e.jsx("code",{className:"block w-full p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-xs text-slate-600 dark:text-slate-400 font-mono truncate",children:B})]}),e.jsxs("div",{children:[e.jsx("label",{className:"text-xs text-slate-500 mb-1 block",children:"访问密码 (Password)"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{type:"text",value:L,readOnly:!0,className:"flex-1 p-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded text-sm outline-none font-mono",placeholder:"未登录 / 未设置"}),e.jsx("button",{onClick:()=>H(L,"pwd"),className:"px-3 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 hover:border-blue-500 rounded text-slate-600 dark:text-slate-400 transition-colors",children:N.pwd?e.jsx(J,{size:16}):e.jsx(Z,{size:16})})]}),e.jsx("p",{className:"text-[10px] text-slate-400 mt-1",children:"此密码对应您部署时设置的 PASSWORD 环境变量。"})]})]})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("h4",{className:"font-medium text-slate-800 dark:text-slate-200 flex items-center gap-2",children:[e.jsx("span",{className:"flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs font-bold",children:"2"}),"选择浏览器类型"]}),e.jsxs("div",{className:"grid grid-cols-2 gap-4",children:[e.jsx("button",{onClick:()=>z("chrome"),className:`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${x==="chrome"?"border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300":"border-slate-200 dark:border-slate-700 hover:border-blue-300 bg-white dark:bg-slate-800"}`,children:e.jsx("span",{className:"font-semibold",children:"Chrome / Edge"})}),e.jsx("button",{onClick:()=>z("firefox"),className:`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${x==="firefox"?"border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300":"border-slate-200 dark:border-slate-700 hover:border-blue-300 bg-white dark:bg-slate-800"}`,children:e.jsx("span",{className:"font-semibold",children:"Mozilla Firefox"})})]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("h4",{className:"font-medium text-slate-800 dark:text-slate-200 flex items-center gap-2",children:[e.jsx("span",{className:"flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs font-bold",children:"3"}),"配置步骤与代码"]}),e.jsxs("div",{className:"bg-slate-50 dark:bg-slate-800/50 p-5 rounded-xl border border-slate-200 dark:border-slate-700",children:[e.jsxs("h5",{className:"font-semibold text-sm mb-3 dark:text-slate-200",children:["安装指南 (",x==="chrome"?"Chrome/Edge":"Firefox","):"]}),e.jsxs("ol",{className:"list-decimal list-inside text-sm text-slate-600 dark:text-slate-400 space-y-2 leading-relaxed",children:[e.jsxs("li",{children:["在电脑上新建文件夹 ",e.jsx("code",{className:"bg-white dark:bg-slate-900 px-1.5 py-0.5 rounded border border-slate-200 dark:border-slate-700 font-mono text-xs",children:"CloudNav-Pro"}),"。"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"[重要]"})," 将下方图标保存为 ",e.jsx("code",{className:"bg-white dark:bg-slate-900 px-1.5 py-0.5 rounded border border-slate-200 dark:border-slate-700 font-mono text-xs",children:"icon.png"}),"。"]}),e.jsxs("li",{children:["获取插件代码文件：",e.jsxs("ul",{className:"list-disc list-inside ml-4 mt-1 space-y-1 text-slate-500",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"方式一 (推荐)："}),"点击下方的 ",e.jsx("span",{className:"text-blue-600 dark:text-blue-400 font-bold",children:'"📦 一键下载所有文件"'})," 按钮，解压到该文件夹。"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"方式二 (备用)："}),"分别点击下方代码块的 ",e.jsx(E,{size:12,className:"inline"})," 按钮下载或复制 ",e.jsx("code",{className:"bg-white dark:bg-slate-900 px-1 rounded",children:"manifest.json"}),", ",e.jsx("code",{className:"bg-white dark:bg-slate-900 px-1 rounded",children:"background.js"})," 等文件到该文件夹。"]})]})]}),e.jsxs("li",{children:["打开浏览器扩展管理页面",x==="chrome"?e.jsxs(e.Fragment,{children:[" (Chrome: ",e.jsx("code",{className:"select-all bg-white dark:bg-slate-900 px-1 rounded",children:"chrome://extensions"}),")"]}):e.jsxs(e.Fragment,{children:[" (Firefox: ",e.jsx("code",{className:"select-all bg-white dark:bg-slate-900 px-1 rounded",children:"about:debugging"}),")"]}),"。"]}),e.jsx("li",{className:"text-blue-600 font-bold",children:"操作关键点："}),e.jsx("li",{children:'1. 开启右上角的 "开发者模式" (Chrome)。'}),e.jsx("li",{children:'2. 点击 "加载已解压的扩展程序"，选择包含上述文件的文件夹。'}),e.jsxs("li",{children:["3. 前往 ",e.jsx("code",{className:"select-all bg-white dark:bg-slate-900 px-1 rounded",children:"chrome://extensions/shortcuts"}),"。"]}),e.jsxs("li",{children:["4. ",e.jsx("strong",{children:"[重要]"}),' 找到 "打开 CloudNav 侧边栏"，设置快捷键 (如 Ctrl+Shift+E)。']})]}),e.jsx("div",{className:"mt-4 mb-4",children:e.jsxs("button",{onClick:ce,disabled:$,className:"w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-70 disabled:cursor-not-allowed text-white font-bold py-3 px-4 rounded-xl transition-colors shadow-lg shadow-blue-500/20",children:[e.jsx(me,{size:20}),$?"打包中...":"📦 一键下载所有文件 (v7.6 Pro)"]})}),e.jsxs("div",{className:"p-3 bg-green-50 dark:bg-green-900/20 text-green-800 dark:text-green-200 rounded border border-green-200 dark:border-green-900/50 text-sm space-y-2",children:[e.jsxs("div",{className:"font-bold flex items-center gap-2",children:[e.jsx(xe,{size:16})," 完美交互方案 (v7.6):"]}),e.jsxs("ul",{className:"list-disc list-inside text-xs space-y-1",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"左键 / 快捷键:"})," 稳定打开侧边栏，首次点击也可直接拉起。"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"网页右键:"})," 直接展示分类列表 (支持判重警告)。"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"图标右键:"})," 同上，统一为级联菜单，直接保存。"]})]})]})]}),e.jsxs("div",{className:"p-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-12 h-12 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center overflow-hidden border border-slate-200 dark:border-slate-600",children:c.favicon?e.jsx("img",{src:c.favicon,className:"w-full h-full object-cover"}):e.jsx(W,{size:24,className:"text-slate-400"})}),e.jsxs("div",{children:[e.jsx("div",{className:"font-medium text-sm dark:text-white",children:"插件图标 (icon.png)"}),e.jsx("div",{className:"text-xs text-slate-500",children:"请保存此图片为 icon.png"})]})]}),e.jsxs("button",{onClick:le,className:"flex items-center gap-2 px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 dark:text-blue-400 rounded-lg transition-colors",children:[e.jsx(E,{size:16})," 下载图标"]})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-2 text-sm font-medium text-slate-800 dark:text-slate-200 pt-2 border-t border-slate-100 dark:border-slate-700",children:[e.jsx(he,{size:18,className:"text-purple-500"})," 核心配置"]}),U("manifest.json",F()),U("background.js",K),e.jsxs("div",{className:"flex items-center gap-2 text-sm font-medium text-slate-800 dark:text-slate-200 pt-2 border-t border-slate-100 dark:border-slate-700",children:[e.jsx(Ie,{size:18,className:"text-green-500"})," 侧边栏导航功能 (Sidebar)"]}),U("sidebar.html",G),U("sidebar.js",q)]})]})]})]}),e.jsx("div",{className:"p-4 border-t border-slate-200 dark:border-slate-700 flex justify-end bg-slate-50 dark:bg-slate-800/50 shrink-0",children:e.jsxs("button",{onClick:ie,className:"flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors shadow-lg shadow-blue-500/20",children:[e.jsx(fe,{size:18})," 保存更改"]})})]})]})})};export{_e as default};
