              ...
              <div className="mt-3 space-y-2">
                <div className="flex justify-between items-center mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-slate-400 dark:text-slate-500">（标签如：主站、备用站、主题贴、发布页）</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      type="button"
                ...
                {urls.map((urlItem, index) => {
                  const predefinedLabels = ['主站', '备用站', '主题贴', '镜像站', '发布页', '官网', '下载页', '文档', 'API'];
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <input
                ...
                className="flex-1 p-2 rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                placeholder="https://example.com/icon.png 或 /api/favicon?..."
              />
              <button
                type="button"
